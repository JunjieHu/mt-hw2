...
python $SCRIPT_DIR/train-model1-sm.py $TRAIN_DATA.de $TRAIN_DATA.en $OUT_DIR/alignment.txt
...
python $SCRIPT_DIR/create-phrase-fst.py $OUT_DIR/phrase_JJ_score.txt $OUT_DIR/phrase-fst.txt
